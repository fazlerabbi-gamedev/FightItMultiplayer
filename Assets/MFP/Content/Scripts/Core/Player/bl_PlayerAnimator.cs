...
public class bl_PlayerAnimator : MonoBehaviour
{
    ...
    private bl_PlayerMovement PlayerController;
    ...
    void SetupSegments()
    {
        ...
        foreach (BendingSegment segment in segments)
        {
            ...
            segment.referenceLookDir =
                parentRotInv * PlayerRoot.rotation * headLookVector.normalized;
            segment.referenceUpDir =
                parentRotInv * PlayerRoot.rotation * headUpVector.normalized;
            segment.angleH = 0;
            segment.angleV = 0;
    ...
    */
    ...
    void LateUpdate()
    {
        ...
        else
        {
            if (PlayerCar.isInVehicle)
            {
                target = PlayerCar.Vehicle.HeatLook.position;
            }
            else
            {
                target = PlayerCar.m_Seat.HeatLook.position;
            }
        }
