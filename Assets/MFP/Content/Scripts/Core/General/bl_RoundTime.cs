...
public class bl_RoundTime : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        isFinish = false;
        if ((string)PhotonNetwork.CurrentRoom.CustomProperties[PropiertiesKeys.RoomRoundKey] == "1")
        {
    ...
    void GetTime()
    {
        RoundDuration = (int)PhotonNetwork.CurrentRoom.CustomProperties[PropiertiesKeys.TimeRoomKey];
